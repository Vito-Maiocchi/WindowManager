...
Desktop::Desktop(int x, int y, int width, int height) {
        Desktop::x = x;
        Desktop::y = y;
        Desktop::width = width;
...
void Desktop::setBgTerminal(unsigned int id) {
        hasBG = true;
        bgTerminal = id;
...
//DisplayManager
void DisplayManager::setDisplay(int x, int y, int width, int height) {
